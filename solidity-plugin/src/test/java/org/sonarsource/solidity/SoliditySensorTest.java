...
public class SoliditySensorTest {
    ...
    private static final Version SONARLINT_DETECTABLE_VERSION = Version.create(25, 9);
    private static final SonarRuntime SONARQUBE_25_9 = SonarRuntimeImpl.forSonarQube(Version.create(25, 9), SonarQubeSide.SERVER, SonarEdition.COMMUNITY);
    ...
    private ActiveRules activeRuleForVersion() {
        ...
        NewActiveRule newActiveRule = builder.setRuleKey(RuleKey.of(SolidityRulesDefinition.REPO_KEY, "ExternalRule1"))
                .setName("Foo Rule").build();

        return (new ActiveRulesBuilder()).addRule(newActiveRule).build();
    }

    private ActiveRules activeFirstRules() {
        NewActiveRule.Builder builder = new NewActiveRule.Builder();
        return (new ActiveRulesBuilder())
                .addRule(builder.setRuleKey(RuleKey.of(SolidityRulesDefinition.REPO_KEY, "ExternalRule1"))
                        .setName("Foo Rule").build())
                .addRule(builder.setRuleKey(RuleKey.of(SolidityRulesDefinition.REPO_KEY, "ExternalRule2"))
                        .setName("Foo Rule2").build())
                .build();
    }
